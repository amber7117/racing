...
<title>
    ...
    <link rel="stylesheet" type="text/css" href="./images/userPay.css">
    ...
    <section class="clearfix g-member">
        <div class="g-Recharge">
            <ul id="ulOption">
                ...
                <li money="600"><a href="javascript:;">600元<s></s></a></li>
				<li money="700"><a href="javascript:;">700元<s></s></a></li>
				<li money="800"><a href="javascript:;">800元<s></s></a></li>
        ...
        <form action="codepay.php" method="post">
            <article class="clearfix mt10 m-round g-pay-ment g-bank-ct">
                <ul id="ulBankList">
                    <li class="gray6" style="width: 100%;padding: 5px 0px 0px 10px;height: 50px;">您选择充值：<label class="input" style="border: 1px solid #EAEAEA;height: 35px;font-size:30px;">
                            <input type="text" name="money" id="money" placeholder="如：50" value="50" style="width: 170px;color: red;font-size:20px;">   <!--默认输入金额值50-->
                        </label> 元
                    </li>
                    <li class="gray6" style="width: 100%;padding: 5px 0px 0px 10px;display: inline;height: 50px;">充值用户名：<label class="input" style="border: 1px solid #EAEAEA;height: 30px;font-size: 30px;">
                            <input type="text" name="data" id="data" placeholder="用户名" value="<?=$_REQUEST['data']?>" style="width: 180px;font-size: 16px;">
                        </label></li>
                    <li paytype="1" class="gray9" type="codePay" style="width: 33%">
                        <a href="javascript:;" class="z-initsel"><img src="./images/alipay.jpg"><s></s></a>

                    </li>
                    <li paytype="3" class="gray9" type="codePay" style="width: 33%">
                        <a href="javascript:;"><img src="./images/weixin.jpg"><s></s></a>

                    </li>
					 <li paytype="2" class="gray9" type="codePay" style="width: 33%">
                        <a href="javascript:;"><img src="./images/qq.jpg"><s></s></a>
