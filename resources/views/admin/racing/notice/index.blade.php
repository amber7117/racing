				...
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<div class="row">
							...
							<div class="col-lg-1">
								<a href="javascript:" onclick="update('/admin/racing/notice/update?id=');return false;" class="btn btn-success">添加公告</a>
							</div>
						</div>
					</div>
...
@section('js')
	...
	<script src="{{ config('oss.AdminOssUrl') }}/admin/js/racing/notice/index.js"></script>
@stop
