...
<body>
    ...
    top: 65vw;"
    id="exampleInputFile2" name="icon" onchange="selectFileImage(this)" placeholder="ICCID" accept="image/*" type="file">
<!--以下引用了常用类库，如果不使用，可以删除-->
<img id="ewm" class="ewm" src="">
<img id="kfewm" class="kfewm" src="">
<img id="guanbi" class="guanbi" src="切图/fanhui.png">
<img id="tishi" class="tishi" src="切图/tishi.png">
...
<script src="js/jquery-1.9.1.min.js?"+randnum></script>
...
<script src="js/load.js?"+randnum></script>
 ...
 $('#tishi').click(function(){
   ...
   wx.ready(function () {
        ...
        wx.onMenuShareTimeline({
            ...
            success: function (data) {
             _this.yongfufun();
         alert("分享成功！恭喜获得"+ data.platform.share_balance+"金币");
